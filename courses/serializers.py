...
class CourseDisplaySerializer(ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['course_uuid', "title", 'rating',
                  'student_no', "author", "price", "image_url"]
...
class CourseListSerializer(ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['course_uuid', "title", 'rating', 'student_no',
                  "author", "price", "image_url", 'description', 'total_lectures']
